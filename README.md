...
| <a name="input_deployment_config"></a> [deployment\_config](#input\_deployment\_config) | PGL configurations | `any` | <pre>{<br>  "blackbox_values_yaml": "",<br>  "dashboard_refresh_interval": "",<br>  "enable_loki_internal_ingress": false,<br>  "enable_prometheus_internal_ingress": false,<br>  "grafana_enabled": true,<br>  "grafana_mimir_values_yaml": "",<br>  "hostname": "",<br>  "karpenter_config": {<br>    "excluded_karpenter_ec2_instance_type": [<br>      ""<br>    ],<br>    "karpenter_ec2_capacity_type": [<br>      ""<br>    ],<br>    "karpenter_values": "",<br>    "private_subnet_name": ""<br>  },<br>  "karpenter_enabled": "",<br>  "loki_hostname": "",<br>  "loki_values_yaml": "",<br>  "mimir_s3_bucket_config": {<br>    "s3_bucket_name": "",<br>    "s3_bucket_region": "",<br>    "versioning_enabled": ""<br>  },<br>  "prometheus_hostname": "",<br>  "prometheus_values_yaml": "",<br>  "storage_class_name": "gp2"<br>}</pre> | no |
